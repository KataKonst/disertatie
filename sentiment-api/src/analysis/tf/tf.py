...
class TFAnalyzer:
    ...
    def init(self):
        f = open('/home/katakonst/disertatie/sent-proj/sentiment-api/src/analysis/tf/dictionary.pickle', 'rb')
        ...
        self.model.load("/home/katakonst/disertatie/sent-proj/sentiment-api/src/analysis/tf/entf.tfl")
